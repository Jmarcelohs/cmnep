...
import { gerarDocxAto } from "@/lib/suplementacoes/gerar-docx";
...
export async function GET(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const buffer = await gerarDocxAto({
    ...
    const filename = `Ato da Mesa Diretora - ${suplementacao.data_ato}.docx`;
    ...
    console.error("Erro ao gerar .docx do Ato", error);
